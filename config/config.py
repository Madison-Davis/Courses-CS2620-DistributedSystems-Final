...
REGIONS         = [0, 1, 2]             # the current geographic regions our app can serve, represented with number IDs
BASE_PORT       = 5000                  # the base port for servers and load-balancers (port = base_port + PID)