...
LB_PID_RANGE        = [0, 3]                # the range of PIDs that our single load-balancer can be insantiated with (V1: we'll have 1+ LBs) [start, end)
LB_BASE_PORT        = 6000                  # the base port for load-balancers (port = base_port + PID)
SERVER_HOSTS        = ["127.0.0.1", "10.250.239.251"]
